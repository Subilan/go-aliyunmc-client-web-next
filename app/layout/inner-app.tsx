...
import { PAGE_NAME_ECONOMY, PAGE_NAME_ECS_CANDIDATES, PAGE_NAME_TASK_LIST, PAGE_NAME_PLAYER_LIST, PAGE_NAME_GAME_STATISTICS, PAGE_NAME_LEADERBOARD, PAGE_NAME_WEB_CHAT } from '~/consts/page-names';
